...
void DenseCRF( Mat& dataim, Mat& annoim, string out, Mat& crfres ){
...
//	crf.addPairwiseBilateral( 50, 50, 5, 5, 5, im, 20 );
	crf.addPairwiseBilateral( 80, 80, 13, 13, 13, im, 10 );
...
//			waitKey(0);
			Mat crfoutput;
			DenseCRF(frame, crfmerged, "crfout.png", crfoutput);
